...
## @deftypefn  {} {} minRawADCEdit_doIt (@var{src}, @var{data}, @var{mainDlg})
##
## Define a callback for default action of minRawADCEdit control.
##
## @end deftypefn
function minRawADCEdit_doIt(src, data, mainDlg)
...
minValueRawADC = str2num(get(mainDlg.minRawADCEdit, 'String'));
end

## @deftypefn  {} {} maxRawADCEdit_doIt (@var{src}, @var{data}, @var{mainDlg})
##
## Define a callback for default action of maxRawADCEdit control.
##
## @end deftypefn
function maxRawADCEdit_doIt(src, data, mainDlg)
...
maxValueRawADC = str2num(get(mainDlg.maxRawADCEdit, 'String'));
end
...
function ret = show_mainDlg()
  ...
  Label_11 = uicontrol( ...
	...
	'ForegroundColor', [0.000 0.000 0.000], ... 
	'HorizontalAlignment', 'left', ... 
	'Position', [230 14 104 19], ... 
	'String', 'Max raw ADC:', ... 
	'TooltipString', '');
  minRawADCEdit = uicontrol( ...
	'parent',loggingSettingsGroupPanel, ... 
	'Style','edit', ... 
	'Units', 'pixels', ... 
	'BackgroundColor', [1.000 1.000 1.000], ... 
	...
	'ForegroundColor', [0.000 0.000 0.000], ... 
	'HorizontalAlignment', 'left', ... 
	'Position', [345 46 103 22], ... 
	'String', '0', ... 
	'TooltipString', '');
  maxRawADCEdit = uicontrol( ...
	'parent',loggingSettingsGroupPanel, ... 
	'Style','edit', ... 
	'Units', 'pixels', ... 
	'BackgroundColor', [1.000 1.000 1.000], ... 
  ...
  mainDlg = struct( ...
      ...
      'Label_10', Label_10, ...
      'Label_11', Label_11, ...
      'minRawADCEdit', minRawADCEdit, ...
      'maxRawADCEdit', maxRawADCEdit, ...
...
set (minRawADCEdit, 'callback', {@minRawADCEdit_doIt, mainDlg});
set (maxRawADCEdit, 'callback', {@maxRawADCEdit_doIt, mainDlg});
